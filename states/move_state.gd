...
func _process(delta: float) -> void:
	...
	if not entity.path_array.front() or entity.current_terrarium.are_entities_blocking_tile(entity.path_array.front(),entity.impassable_group_list):
